	soc_system u0 (
		...
		.d5m_top_0_camera_interface_mclk      (<connected-to-d5m_top_0_camera_interface_mclk>),      // d5m_top_0_camera_interface.mclk
		.d5m_top_0_camera_interface_pclk      (<connected-to-d5m_top_0_camera_interface_pclk>),      //                           .pclk
		.d5m_top_0_camera_interface_data      (<connected-to-d5m_top_0_camera_interface_data>),      //                           .data
		.d5m_top_0_camera_interface_fval      (<connected-to-d5m_top_0_camera_interface_fval>),      //                           .fval
		.d5m_top_0_camera_interface_lval      (<connected-to-d5m_top_0_camera_interface_lval>),      //                           .lval
		.d5m_top_0_camera_interface_cam_reset (<connected-to-d5m_top_0_camera_interface_cam_reset>), //                           .cam_reset
		.display_conduit_lt24_cs_n            (<connected-to-display_conduit_lt24_cs_n>),            //            display_conduit.lt24_cs_n
		.display_conduit_lt24_d               (<connected-to-display_conduit_lt24_d>),               //                           .lt24_d
		.display_conduit_lt24_lcd_on          (<connected-to-display_conduit_lt24_lcd_on>),          //                           .lt24_lcd_on
		.display_conduit_lt24_rd_n            (<connected-to-display_conduit_lt24_rd_n>),            //                           .lt24_rd_n
		.display_conduit_lt24_reset_n         (<connected-to-display_conduit_lt24_reset_n>),         //                           .lt24_reset_n
		.display_conduit_lt24_rs_d_cx         (<connected-to-display_conduit_lt24_rs_d_cx>),         //                           .lt24_rs_d_cx
		.display_conduit_lt24_wr_n            (<connected-to-display_conduit_lt24_wr_n>),            //                           .lt24_wr_n
		...
		.d5m_top_1_camera_interface_mclk      (<connected-to-d5m_top_1_camera_interface_mclk>),      // d5m_top_1_camera_interface.mclk
		.d5m_top_1_camera_interface_pclk      (<connected-to-d5m_top_1_camera_interface_pclk>),      //                           .pclk
		.d5m_top_1_camera_interface_data      (<connected-to-d5m_top_1_camera_interface_data>),      //                           .data
		.d5m_top_1_camera_interface_fval      (<connected-to-d5m_top_1_camera_interface_fval>),      //                           .fval
		.d5m_top_1_camera_interface_lval      (<connected-to-d5m_top_1_camera_interface_lval>),      //                           .lval
		.d5m_top_1_camera_interface_cam_reset (<connected-to-d5m_top_1_camera_interface_cam_reset>)  //                           .cam_reset
	);
