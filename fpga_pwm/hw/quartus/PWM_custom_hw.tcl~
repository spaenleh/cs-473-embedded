...
set_module_property NAME PWM_custom
...
add_fileset_file PWM.vhd VHDL PATH ../vhdl/PWM.vhd TOP_LEVEL_FILE
add_fileset_file clk_div.vhd VHDL PATH ../vhdl/clk_div.vhd
...
add_interface_port conduit_end PWM_out conduit Output 1
