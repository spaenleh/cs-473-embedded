	soc_system u0 (
		...
		.d5m_top_0_cam_interface_data        (<connected-to-d5m_top_0_cam_interface_data>),        //      d5m_top_0_cam_interface.data
		.d5m_top_0_cam_interface_pclk        (<connected-to-d5m_top_0_cam_interface_pclk>),        //                             .pclk
		.d5m_top_0_cam_interface_fval        (<connected-to-d5m_top_0_cam_interface_fval>),        //                             .fval
		.d5m_top_0_cam_interface_lval        (<connected-to-d5m_top_0_cam_interface_lval>),        //                             .lval
		.d5m_top_0_cam_interface_mclk        (<connected-to-d5m_top_0_cam_interface_mclk>),        //                             .mclk
		.d5m_top_0_cam_interface_cam_reset   (<connected-to-d5m_top_0_cam_interface_cam_reset>)    //                             .cam_reset
	);
